drop function if exists "public"."get_all_search_jobs"(p_page integer, p_search text, p_is_verified boolean, p_country_ids uuid[], p_experience_level_id uuid, p_sort_order text);
