...
export function QuestionContent({ job_posting_id }: QuestionContentProps) {
  ...
  const { createComment, isCreating } = useCreateComment({
    entity_type: DBTable.JOB_POSTING,
              ...
              <div className="flex flex-col">
                <div className="mb-2 flex items-start justify-between">
                  <div className="flex items-center gap-2">
                    <Avatar className="flex-shrink-0" name={question.full_name} size="sm" src={question.profile_pic_url} />
                    <span className="font-semibold">{question.full_name}</span>
                  </div>
